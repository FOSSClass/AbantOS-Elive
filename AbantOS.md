...
This file is open for only users, and it is readable and writable for root account.
...
4. Python3-dbg: sudo apt-get install python-dbg. Libraries built against versions of Python configured with pydebug. Allows python configuration.
